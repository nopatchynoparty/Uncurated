...
const ARCHETYPE_EMAIL_ICONS: Record<string, string> = {
  "The Dark Escapist": "🌙", "The Compulsive Page-Turner": "⚡", "The World-Builder": "🪐",
  "The Reluctant Literary": "📖", "The True Crime Mind": "🔍", "The Intellectual Adventurer": "🔭",
  "The Comfort Rereader": "🤍", "The Historical Immersionist": "⏳", "The Concept Reader": "👾",
  "The Quiet Realist": "👁", "The Epic Completionist": "🗺", "The Atmosphere Chaser": "✨",
};

const GAMES_ARCHETYPE_EMAIL_ICONS: Record<string, string> = {
  "The Completionist": "🏆", "The Story Chaser": "📖", "The Hardcore": "💀",
  "The Explorer": "🗺️", "The Strategist": "♟️", "The Couch Co-op": "🎮",
  "The Rogueliker": "🔄", "The Immersionist": "🌍", "The Speedrunner": "⚡",
  "The Indie Darling": "🎨", "The Retro Purist": "👾", "The Casual Drifter": "☁️",
};

const WATCH_ARCHETYPE_EMAIL_ICONS: Record<string, string> = {
  "The Prestige Drama Addict": "🏆", "The Binge Monster": "⚡", "The Dark & Twisted": "🌑",
  "The Feel-Good Faithful": "☀️", "The True Crime Obsessive": "🔍", "The Sci-Fi Escapist": "🚀",
  "The Comfort Rewatcher": "🛋️", "The Doc Devotee": "🎥", "The Sharp Comedy Fan": "😏",
  "The Slow Burn Devotee": "🕯️", "The Foreign Language Explorer": "🌍", "The Underdog Champion": "🥊",
};
...
function isTrustedUrl(url: string): boolean {
  ...
  try {
    ...
    const trusted = ["www.amazon.co.uk", "amazon.co.uk", "www.amazon.com", "amazon.com", "open.spotify.com", "www.justwatch.com"];
...
export async function POST(request: NextRequest) {
  ...
  const { email, taste_profile, recommendations, category, colorScheme, archetype, archetype_secondary } = body;
  ...
  if (!taste_profile || typeof taste_profile !== "string") {
    return Response.json({ error: "Missing taste profile." }, { status: 400 });
  }
  if (!Array.isArray(recommendations) || recommendations.length === 0 || recommendations.length > 10) {
    return Response.json({ error: "Invalid recommendations." }, { status: 400 });
  }
